...
mod integration_tests {
    use super::super::ser_2026::{deserialize_2026, serialize_2026};
        ...
        match new_allocator.sexp(deserialized) {
            crate::allocator::SExp::Pair(left, right) => {
                ...
                match new_allocator.sexp(left) {
                    crate::allocator::SExp::Pair(l1, r1) => {
                ...
                match new_allocator.sexp(right) {
                    crate::allocator::SExp::Pair(l2, r2) => {
